...
# Loading models
tplh_model = joblib.load('/home/eduarda/Repos/jupyter_ic/models/trained/MLP_Regressor/CMOS/32nm/NOT/single_output/grid_search_tuning_test/tplh/TESTES/T4/best_GS_tplh.joblib')
...
plt.savefig("/home/eduarda/Repos/jupyter_ic/notebooks/CMOS/32nm/NOT/MLP_Regressor/SKL/single_output/gridSearch/tplh/TESTES/T4/residuals_physical"
"/residuals.png")
plt.show()
plt.close()
