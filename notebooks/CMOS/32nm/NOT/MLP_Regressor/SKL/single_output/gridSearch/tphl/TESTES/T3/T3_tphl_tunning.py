...
save_models_dir = '/home/eduarda/Repos/jupyter_ic/models/trained/MLP_Regressor/CMOS/32nm/NOT/single_output/grid_search_tuning_test/tphl/TESTES/T3'
...
# Path
untrained_model_path = '/home/eduarda/Repos/jupyter_ic/models/untrained/mlp_regressor_SKL_untrained_tphl_tplh_teste3_4.joblib'
...
my_pipeline = Pipeline([("scaler", MinMaxScaler()), ("mlp", mlp_regressor)])

model_with_scaler_y = TransformedTargetRegressor(
    regressor=my_pipeline, transformer=MinMaxScaler()
)

param_grid = {
    "regressor__mlp__hidden_layer_sizes": [(100, 50), (100, 100), (150, 50), (100, 50, 25)],
...
# Comando para rodar:
#time /home/eduarda/Repos/jupyter_ic/venv/bin/python /home/eduarda/Repos/jupyter_ic/notebooks/CMOS/32nm/NOT/MLP_Regressor/SKL/single_output/gridSearch/tphl/TESTES/T3/T3_tphl_tunning.py