...
# Loading models
tplh_model = joblib.load('/home/eduarda/Repos/jupyter_ic/models/trained/MLP_Regressor/CMOS/32nm/NOT/single_output/grid_search_tuning_test/tplh/TESTES/T1/best_GS_tplh.joblib')
