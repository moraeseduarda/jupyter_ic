...
# Loading models
tphl_model = joblib.load('/home/eduarda/Repos/jupyter_ic/models/trained/MLP_Regressor/CMOS/32nm/NOT/single_output/grid_search_tuning_test/tphl/TESTES/T2/best_GS_tphl.joblib')
...
plt.savefig("/home/eduarda/Repos/jupyter_ic/notebooks/CMOS/32nm/NOT/MLP_Regressor/SKL/single_output/gridSearch/tphl/TESTES/T2/residuals_normalized"
"/residuals.png")
plt.show()
plt.close()
...
plt.ylabel('Residuals / Errors')
plt.grid(True, alpha=0.3)
plt.savefig("/home/eduarda/Repos/jupyter_ic/notebooks/CMOS/32nm/NOT/MLP_Regressor/SKL/single_output/gridSearch/tphl/TESTES/T2/residuals_physical"
"/residuals.png")
plt.show()
plt.close()
